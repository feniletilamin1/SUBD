    ...
    <section class="section">
        <div class="main-container">
            ...
            <div class="info">
                ...
                <h1 class="info__title info__title--margin-bottom40px">Добавление нового клиента</h1>
                    <form action="scenaries/clientAdd.php" class="edit-form" method="POST" enctype="multipart/form-data">
                        <label class="edit-form__label" for="avatar">Аватар</label>
                        <input required type="file" id="avatar" class="edit-form__input" name="client_avatar">
                        <label class="edit-form__label" for="name">Фамилия</label>
                        <input required type="text" id="name" name="client_last-name" class="edit-form__input">
                        <label class="edit-form__label" for="first-name">Имя</label>
                        <input required type="text" id="first-name" name="client_first-name" class="edit-form__input">
                        <label class="edit-form__label" for="middle-name">Отчество</label>
                        <input required type="text" id="middle-name" name="client_middle-name" class="edit-form__input">
                        <label class="edit-form__label" for="phone">Телефон</label>
                        <input required type="text" id="phone" name="client_phone" class="edit-form__input mask-phone">
