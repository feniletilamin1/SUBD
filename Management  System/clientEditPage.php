        ...
        <div class="main-container">
            <div class="menu">
                <div class="menu__wrapper">
                    ...
                    <ul class="menu__list">
                        ...
                        <li class="menu__list-item menu__list-item--client menu__list-item--active ">
            ...
            <div class="info">
                <div class="info__wrapper">
                    <h1 class="info__title">Редактирование данных клиента</h1>
                            ...
                            <tr class="info__table-row">
                                <td class="info__table-column">
                                    <div class="info__table-column-avatar">
                                        <img src="<?='data:image/png;base64,' . base64_encode($row['client_avatar'])?>" alt="avatar.jpg" class="info__table-column-avatar-image">
                                    </div>
                                </td>
                                <td class="info__table-column"><?=$row['client_last_name']?></td>
                                <td class="info__table-column"><?=$row['client_first_name']?></td>
                                <td class="info__table-column"><?=$row['client_middle_name']?></td>
                                <td class="info__table-column"><?=$row['client_phone']?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                <form action="scenaries/clientUpdate.php?id=<?=$id?>" class="edit-form" method="POST" enctype="multipart/form-data">
                    <label class="edit-form__label" for="avatar">Аватар</label>
                    <input type="file" id="avatar" class="edit-form__input" name="client_avatar">
                    <label class="edit-form__label" for="name">Фамилия</label>
                    <input type="text" id="name" name="client_last-name" class="edit-form__input">
                    <label class="edit-form__label" for="first-name">Имя</label>
                    <input type="text" id="first-name" name="client_first-name" class="edit-form__input">
                    <label class="edit-form__label" for="middle-name">Отчество</label>
                    <input type="text" id="middle-name" name="client_middle-name" class="edit-form__input">
                    <label class="edit-form__label" for="phone">Телефон</label>
                    <input type="text" id="phone" name="client_phone" class="edit-form__input mask-phone">
