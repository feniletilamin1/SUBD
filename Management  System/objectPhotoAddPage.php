...
<head>
    ...
    <title>Добавление фото объекта</title>
</head>
<body>
        ...
        <div class="main-container">
            ...
            <div class="info">
                <div class="info__wrapper">
                    <h1 class="info__title info__title--margin-bottom40px">Добавление нового фото объекта</h1>
                    <form action="scenaries/objectPhotoAdd.php?id=<?=$id?>" class="edit-form" method="POST" enctype="multipart/form-data">
                        <label class="edit-form__label" for="avatar">Фото</label>
                        <input required type="file" id="avatar" class="edit-form__input" name="object_img">
                        <label class="edit-form__label">Описание</label>
                        <input type="text" class="edit-form__input" name="object_desc">
