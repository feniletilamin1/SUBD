<?php 
    ...
    if(avatarSecurity($avatar)) {
        ...
        $request = "INSERT INTO workers (worker_avatar, worker_last_name, worker_first_name, worker_middle_name, worker_phone, worker_status, worker_post) VALUES ('$img', '$lastName', '$firstName', '$middleName', '$phone', 'Свободен', '$post')";
