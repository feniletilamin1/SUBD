        ...
        <div class="main-container">
            ...
            <div class="info">
                <div class="info__wrapper">
                    <h1 class="info__title info__title--margin-bottom40px">Добавление нового заказа</h1>
                    <form action="scenaries/orderAdd.php" class="edit-form" method="POST">
                        <label class="edit-form__label" for="name">Наименование объекта</label>
                        <input required type="text" id="name" name="order_name" class="edit-form__input">
                        <label class="edit-form__label" for="first-name">Сумма заказа</label>
                        <input required type="text" id="first-name" name="order_amount" class="edit-form__input">
                        <label class="edit-form__label" for="middle-name">Дата размещения</label>
                        <input required type="date" id="middle-name" name="order_end_date" class="edit-form__input">
                        <label class="edit-form__label" for="phone">Плановая дата завершения</label>
                        <input required type="date" id="phone" name="order_start_date" class="edit-form__input">
